...
export const en: Copy = {
  ...
  catalog: {
    ...
    count: { one: "{n} session", other: "{n} sessions" },
    filterAll: "All",
  ...
  home: {
    ...
    bankNote: "Pick an area and tune the rest",
    bankAll: "All",
  ...
  intentionInput: {
    ...
    placeholder: "Write your intention: work keeps me from sleeping…",
    submit: "Continue",
    suggestionsLabel: "Suggestions",
    suggestions: [
      "Work keeps me from sleeping",
      "Anxious at the end of the month",
  ...
  player: {
    ...
    scriptTitle: "Script",
    scriptNote: "What is said, passage by passage.",
    scriptEmpty: "No text.",
